package io.github.nikita756.responsifintech.Helper
 ...
 */
     ...
     * @return
     */
    fun isInputEditTextFilled(textInputEditText: TextInputEditText, textInputLayout: TextInputLayout, message:
    String): Boolean {
